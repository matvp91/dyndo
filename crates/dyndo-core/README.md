...
the `Track` domain model, the `asset.json` serde contract, RFC 6381 codec
strings, and the grouping of fragments into served segments. It has no CLI,
...
specifies the descriptor this crate reads and writes.
