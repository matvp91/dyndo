...
| ------------------------------------- | ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`dyndo-core`](crates/dyndo-core)     | library                 | CMAF parsing, track and segment models, CPIX policy resolution, CENC encryption, byte-range reading, WebVTT packaging, and thumbnail generation. Reads storage through [OpenDAL](https://opendal.apache.org/). |
