...
- **Create delivery variants at request time.** Filters, segment lengths, boundaries, DASH periods, and HLS subtitle form can vary without producing another media library.
